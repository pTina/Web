...
var CONTENT_URL = 'https://api.hnpwa.com/v0/item/@id.json'; // 공유되는 자원
...
function newsFeed() {
  ...
  var lastPage = Math.round(newsFeed.length / 10);
  var newsList = [];
  ...
  for (var i = (store.currentPage - 1) * 10; i < store.currentPage * 10; i++) {
    newsList.push("\n            <li class = \"".concat(newsFeed[i].read ? 'text-pink-700' : 'text-white', " bg-[#533CA6] p-10 mb-10 rounded-xl text-white flex justify-between\">\n                <p>\n                    <a href=\"#/show/").concat(newsFeed[i].id, "\" class=\"block\">\n                        ").concat(newsFeed[i].title, "\n                    </a>\n                    <span class=\"mr-5\"><i class=\"fa-solid fa-user mr-2\"></i>").concat(newsFeed[i].user, "</span>\n                    <span class=\"mr-7\"><i class=\"fa-solid fa-heart\"></i>").concat(newsFeed[i].points, "</span>\n                    <span class=\"text-[12px]\"><i class=\"fa-solid fa-clock-rotate-left mr-2\"></i>").concat(newsFeed[i].time_ago, "</span>\n                </p>\n                <p class=\"flex items-center\">\n                    <i class=\"fa-solid fa-comments mr-2\"></i>\n                    <a href=\"#/show/").concat(newsFeed[i].id, "\">\n                        ").concat(newsFeed[i].comments_count, "\n                    </a>\n                </p>\n            </li>\n        "));
  }
...
function newsDetail() {
  ...
  var template = "\n        <div class=\"continer m-auto p-10\">\n            <div class=\"flex justify-between\">\n                <h1 class=\"mb-10\">Hacker News</h1>\n                <span><a href=\"#/page/".concat(store.currentPage, "\"><i class=\"fa-solid fa-xmark\"></i></a></span>\n            </div>\n            \n            <div class=\"bg-[#533CA6] rounded-xl text-white p-10\">\n                <h1>").concat(newsContent.title, "</h1>\n                <div>{{__content__}}</div>\n                <div>{{__comments__}}</div>\n            </div>\n        </div>\n    ");

  function makeContent(content) {
    if (content) {
      return content;
    } else {
      return "<a href=\"".concat(content.url, "\" target=\"_black\">link click</a>");
    }
  }
  ...
  function makeComments(comments) {
    ...
    for (var _i = 0; _i < comments.length; _i++) {
      commentsList.push("\n                <div class=\"ml-".concat(10 * called, "\">\n                    <div class=\"bg-[#fff] text-[#000]\">\n                        <i class=\"fa-solid fa-caret-down\"></i>\n                        <span class=\"mr-2\">").concat(comments[_i].user, "</span>\n                        <span><i class=\"fa-solid fa-clock-rotate-left mr-2\"></i>").concat(comments[_i].time_ago, "</span>\n                    </div>\n                    <div class=\"ml-10\">").concat(comments[_i].content, "</div>\n                </div>\n            "));

      if (comments[_i].comments.length > 0) {
        commentsList.push(makeComments(comments[_i].comments, called + 1));
      }
    }
...
window.addEventListener('hashchange', router); // newsFeed();
...
},{}]},{},["../../../../../.npm-globaal/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
